...
# importing from web
df = pd.read_csv('http://hedibert.org/wp-content/uploads/2016/02/wage.txt',sep="\t", header=0)
...
# Separando dependentes e independente 
df_var = df[['educ', 'exper', 'female', 'married']]
...
variables = sm.add_constant(df_var)
...
# criando dfs de teste e treino
# tamanho = 0.75 do df original
train_size = int(0.7* df.shape[0])

# variaveis de treino 0 - 75%
train_features = variables[:train_size]
# target ou var. explicativa de treino 0 - 75%
train_targets = targets[:train_size]

# dfs de teste
test_features = variables[train_size:]
test_targets = targets[train_size:]

#tamanhos
print(variables.shape, train_features.shape, test_features.shape)
